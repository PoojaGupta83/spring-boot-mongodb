...
package com.programmingexpense.springbootmongodb.mongo.service;
...
import com.programmingexpense.springbootmongodb.constants.CommonConstants;
import com.programmingexpense.springbootmongodb.handler.exception.ValidationException;
import com.programmingexpense.springbootmongodb.mongo.commons.CustomIndexOptions;
import com.programmingexpense.springbootmongodb.mongo.dao.MongoIndex;
import com.programmingexpense.springbootmongodb.mongo.dao.MongoRepository;
import com.programmingexpense.springbootmongodb.mongo.dto.result.DeleteDocResult;
import com.programmingexpense.springbootmongodb.mongo.dto.result.UpdateDocResult;
import com.programmingexpense.springbootmongodb.mongo.enums.Order;
import com.programmingexpense.springbootmongodb.utils.CommonUtils;
...
import static com.programmingexpense.springbootmongodb.constants.ApplicationConstants.COMMA;
 ...
 * <br><br>{@link #read(Class type, Document query)} This method is used to find single value from mongodb collection based on different-different parameters.
...
//        checkTimeToMethodComplete(startTime);
     ...
     *
     * @param type     is the name of the collection on which operation is being performed.
     * @param resource document to be inserted in collection.
     * @return true of type {boolean}
     */
    @Override
    public boolean create(Class type, T resource) {
        ...
        mongoRepository.insertOne(getCollectionName(type), Document.parse(resourceJson));
        return true;
    }
     ...
     */
    @Override
    public Document read(Class type, Document query) {
        query = Objects.isNull(query) ? new Document() : query;
        return mongoRepository.findOne(getCollectionName(type), query, null, null);
    }
...
//        }
    ...
    public String getCollectionName(Class type) {
        com.programmingexpense.springbootmongodb.annotation.Document document = (com.programmingexpense.springbootmongodb.annotation.Document) type.getAnnotation(com.programmingexpense.springbootmongodb.annotation.Document.class);
