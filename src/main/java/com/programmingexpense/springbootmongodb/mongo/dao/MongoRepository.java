...
import com.programmingexpense.springbootmongodb.mongo.config.MongoConfig;
import com.programmingexpense.springbootmongodb.mongo.constants.MongoConstants;
...
import static com.programmingexpense.springbootmongodb.mongo.utils.MongoUtils.nonNullAndEmpty;
...
public class MongoRepository {
    ...
    public long count(String collection, Document match) {
        return Objects.nonNull(match) ? getDB().getCollection(collection).count(match) : -1;
    }
