...
import com.programmingexpense.springbootmongodb.handler.response.ApiResponseCode;
import com.programmingexpense.springbootmongodb.handler.response.ResponseUtil;
import com.programmingexpense.springbootmongodb.handler.response.ValidationErrorDTO;
...
import static com.programmingexpense.springbootmongodb.constants.ApplicationConstants.EMPTY_STRING;
            ...
            errors.getFieldErrors().forEach(field ->
                    errorResponse.addError(new ValidationErrorDTO.FieldErrorDTO(field.getField(),
                            messageSource.getMessage(field.getDefaultMessage(),
                                    null,
                                    responseUtil.getLocale(com.programmingexpense.springbootmongodb.utils.CommonUtils.getLocaleStringFromClientHTTPRequest(httpServletRequest))))));
